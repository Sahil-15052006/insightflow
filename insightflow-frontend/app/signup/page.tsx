...
export default function SignupPage() {
  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2 bg-[radial-gradient(circle,rgba(255,255,255,0.10)_1px,transparent_1px)] bg-size-[7px_7px] bg-black text-white dark">
      ...
      <div className="relative hidden bg-muted lg:block">
        <Image
          ...
          width="10"
          height="8"
          className="absolute inset-0 h-full w-full bg-[linear-gradient(to_top,rgba(144,70,200,1),transparent)] "
        />
      </div>
    </div>
  )
